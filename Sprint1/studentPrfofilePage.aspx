<%@ Page Title="" Language="C#" MasterPageFile="~/studentMaster.Master" AutoEventWireup="true" CodeBehind="studentPrfofilePage.aspx.cs" Inherits="Sprint1.studentPrfofilePage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div>
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="PhoneNumber" />
            <asp:Parameter Name="Major" />
            <asp:Parameter Name="ExpectedGradYear" />
            <asp:Parameter Name="UniversityYear" />
            <asp:Parameter Name="StudentID" />
        </UpdateParameters>
        </asp:SqlDataSource>
    </div>
