    ...
    public partial class editJobs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                String membersQuery = "SELECT JobTitle, DateStart, DateEnd, Description, ApplicationLink FROM Job WHERE JobID =" + s + ";";
        ...
        {
            {
                ...
                String s = Session["EditJobID"].ToString();
                sc.CommandText = "Update Job SET JobTitle = @Title, DateStart = @Start, DateEnd = @End, Description" +
