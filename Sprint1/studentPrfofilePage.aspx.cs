...
//SqlDataSource Imports
using System.Data;

namespace Sprint1
{
    public partial class studentPrfofilePage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //Hard coding in Session Student ID until Login page done
            //Session["StudentID"] = Session["LoggedInUserID"].ToString();
            Session["StudentID"] = 1;
            updateFROMDB();
        }
        ...
        protected void btnUploadFile_Click(object sender, EventArgs e)
        {
            ...
            if (fileUploadText.HasFile)
            {
                ...
                if (File.Exists(fpath))
                {
                    ...
                    //update StudentResume column from null to StudentResume file name
        ...
        protected void bttnpdf_Click(object sender, EventArgs e)
        {
            ...
            string FilePath = Server.MapPath("StudentResume") + "\\" + StudentResumename;
